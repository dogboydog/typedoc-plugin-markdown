...
import { ArrayType, ReferenceType, Type } from 'typedoc';

import { MarkdownBuilder } from '../tools/builder';
import { heading, link } from '../tools/elements';
import { escapeChars } from '../tools/utils';
import { linkTemplate } from './link';

export function sourcesTemplate(
...
const getUrl = (name: string, url: string) => linkTemplate(name, url);
